 ...
 *
 */
extern void WXSwizzleInstanceMethod(_Nonnull Class class_, _Nonnull SEL original, _Nonnull SEL replaced);

extern void WXSwizzleInstanceMethodWithBlock(_Nonnull Class class_, _Nonnull SEL original, _Nonnull id block, _Nonnull SEL replaced);
